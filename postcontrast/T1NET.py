...
# -------------------------------------------------------------------------------------------
    ...
    # laod data for training, validation, and testing
    train_set = loadData(split='train',N=3,path=path)
    val_set = loadData(split='validation',N=3,path=path)
    test_set = loadData(split='test',N=3,path=path)
    ...
    for epoch in range(nepoch):
        ...
        # Tensorboard writer for training intermediate dt
        ...
        # Tensorboard writer for vlidation intermediate data
        ...
        # Tensorboard writer for testing intermediate dat
        ...
        # save intermediate networks according to save interval
